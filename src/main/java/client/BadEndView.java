...
/**
 * Widok końca gry w wisielca kiedy hasło nie zostało zgadnięte
 *
 * @author Tomasz Gajos
 */
public class BadEndView extends javax.swing.JFrame {

    /**
     * Tworzy instancję BadEndView i inicjalizuje jej składniki
     *
     * @param phrase hasło, które nie zostało zgadnięte przez gracza
     * @param clientWorker wątek odpowiadający za zarządzanie stanem gry
     */
    public BadEndView(String phrase, ClientWorker clientWorker) {
        initComponents();
        phraseLabel.setText(phrase);
        this.clientWorker = clientWorker;
        add(object);
        object.setSize(500, 500);
        object.setIncorrectGuesses(11);
        object.repaint();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Koniec gry, gracz nie zdołał zgadnąć hasła:");
